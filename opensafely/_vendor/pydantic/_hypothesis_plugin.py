...
https://docs.pydantic.dev/usage/types/#opensafely._vendor.pydantic.types
...
from opensafely._vendor.pydantic.utils import lenient_issubclass
...
for typ in list(opensafely._vendor.pydantic.types._DEFINED_TYPES):
    _registered(typ)
