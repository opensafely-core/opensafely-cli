...
from opensafely._vendor.ruyaml.compat import nprintf  # NOQA
from opensafely._vendor.ruyaml.compat import ordereddict  # NOQA; type: ignore
from opensafely._vendor.ruyaml.compat import _F, MutableSliceableSequence
from opensafely._vendor.ruyaml.scalarstring import ScalarString
...
class CommentedBase:
    ...
    def yaml_set_start_comment(self, comment, indent=0):
        ...
        """
        from opensafely._vendor.ruyaml.error import CommentMark
        from opensafely._vendor.ruyaml.tokens import CommentToken
