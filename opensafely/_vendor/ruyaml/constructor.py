...
from opensafely._vendor.ruyaml.comments import *  # NOQA
from opensafely._vendor.ruyaml.comments import (
    C_KEY_EOL,
    C_KEY_POST,
    C_KEY_PRE,
    C_VALUE_EOL,
...
from opensafely._vendor.ruyaml.compat import builtins_module  # NOQA
from opensafely._vendor.ruyaml.compat import ordereddict  # type: ignore
from opensafely._vendor.ruyaml.compat import _F, nprintf
...
from opensafely._vendor.ruyaml.nodes import MappingNode, ScalarNode, SequenceNode
from opensafely._vendor.ruyaml.scalarbool import ScalarBoolean
from opensafely._vendor.ruyaml.scalarfloat import ScalarFloat
from opensafely._vendor.ruyaml.scalarint import BinaryInt, HexCapsInt, HexInt, OctalInt, ScalarInt
from opensafely._vendor.ruyaml.scalarstring import (
...
from opensafely._vendor.ruyaml.timestamp import TimeStamp
from opensafely._vendor.ruyaml.util import create_timestamp, timestamp_regexp
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_rt_sequence(self, node, seqtyp, deep=False):
        ...
        if node.anchor:
            from opensafely._vendor.ruyaml.serializer import templated_id
    ...
    def construct_yaml_object(self, node, cls):
        ...
        if hasattr(data, '__setstate__'):
            ...
            if hasattr(data, '__attrs_attrs__'):  # issue 394
                ...
                data.__dict__.update(state)
        if node.anchor:
            from opensafely._vendor.ruyaml.anchor import Anchor
            from opensafely._vendor.ruyaml.serializer import templated_id
