...
from opensafely._vendor.ruyaml.comments import C_POST, C_PRE, C_SPLIT_ON_FIRST_BLANK
from opensafely._vendor.ruyaml.compat import _F, nprint, nprintf  # NOQA
from opensafely._vendor.ruyaml.error import MarkedYAMLError
from opensafely._vendor.ruyaml.events import *  # NOQA
from opensafely._vendor.ruyaml.scanner import (  # NOQA
    BlankLineComment,
    RoundTripScanner,
    Scanner,
    ScannerError,
