...
from opensafely._vendor.ruyaml.compat import DBG_NODE, dbg, nprint, nprintf  # NOQA
from opensafely._vendor.ruyaml.error import YAMLError
from opensafely._vendor.ruyaml.events import (
    AliasEvent,
    DocumentEndEvent,
    DocumentStartEvent,
    MappingEndEvent,
...
from opensafely._vendor.ruyaml.util import RegExp

if False:  # MYPY
    from typing import Any, Dict, Optional, Text, Union  # NOQA

    from opensafely._vendor.ruyaml.compat import VersionType  # NOQA
