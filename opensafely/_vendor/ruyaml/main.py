...
from opensafely._vendor import ruyaml
from opensafely._vendor.ruyaml.comments import C_PRE, CommentedMap, CommentedSeq
from opensafely._vendor.ruyaml.compat import (  # NOQA
    StreamTextType,
    StreamType,
    VersionType,
    nprint,
...
from opensafely._vendor.ruyaml.constructor import (
    BaseConstructor,
    Constructor,
    RoundTripConstructor,
    SafeConstructor,
)
from opensafely._vendor.ruyaml.dumper import BaseDumper, Dumper, RoundTripDumper, SafeDumper  # NOQA
from opensafely._vendor.ruyaml.error import UnsafeLoaderWarning, YAMLError  # NOQA
from opensafely._vendor.ruyaml.events import *  # NOQA
from opensafely._vendor.ruyaml.loader import BaseLoader  # NOQA; NOQA
from opensafely._vendor.ruyaml.loader import Loader
from opensafely._vendor.ruyaml.loader import Loader as UnsafeLoader
from opensafely._vendor.ruyaml.loader import RoundTripLoader, SafeLoader
from opensafely._vendor.ruyaml.nodes import *  # NOQA
from opensafely._vendor.ruyaml.representer import (
    BaseRepresenter,
    Representer,
    RoundTripRepresenter,
    SafeRepresenter,
)
from opensafely._vendor.ruyaml.resolver import Resolver, VersionedResolver  # NOQA
from opensafely._vendor.ruyaml.tokens import *  # NOQA

if False:  # MYPY
    from pathlib import Path
    from typing import Any, Callable, Dict, List, Optional, Set, Text, Union  # NOQA

    from opensafely._vendor.ruyaml.compat import StreamTextType, StreamType, VersionType  # NOQA
...
def warn_deprecation(fun, method, arg=''):
    ...
    from opensafely._vendor.ruyaml.compat import _F
