...
from opensafely._vendor.opentelemetry.trace.span import INVALID_SPAN
...
class ExemplarReservoir(ABC):
    ...
    def collect(self, point_attributes: Attributes) -> List[Exemplar]:
        ...
        Returns:
            a list of ``opensafely._vendor.opentelemetry.sdk.metrics._internal.exemplar.exemplar.Exemplar`` s. Returned
