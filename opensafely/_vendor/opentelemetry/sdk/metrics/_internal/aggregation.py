...
from opensafely._vendor.opentelemetry.sdk.metrics._internal.exponential_histogram.buckets import (
    Buckets,
)
from opensafely._vendor.opentelemetry.sdk.metrics._internal.exponential_histogram.mapping import (
    Mapping,
)
from opensafely._vendor.opentelemetry.sdk.metrics._internal.exponential_histogram.mapping.exponent_mapping import (
    ExponentMapping,
)
from opensafely._vendor.opentelemetry.sdk.metrics._internal.exponential_histogram.mapping.logarithm_mapping import (
    LogarithmMapping,
)
from opensafely._vendor.opentelemetry.sdk.metrics._internal.measurement import Measurement
from opensafely._vendor.opentelemetry.sdk.metrics._internal.point import Buckets as BucketsPoint
from opensafely._vendor.opentelemetry.sdk.metrics._internal.point import (
    ExponentialHistogramDataPoint,
    HistogramDataPoint,
    NumberDataPoint,
    Sum,
)
from opensafely._vendor.opentelemetry.sdk.metrics._internal.point import Gauge as GaugePoint
from opensafely._vendor.opentelemetry.sdk.metrics._internal.point import (
...
class DefaultAggregation(Aggregation):
    ...
    ==================================================== ====================================
    `opensafely._vendor.opentelemetry.sdk.metrics.Counter`                  `SumAggregation`
    `opensafely._vendor.opentelemetry.sdk.metrics.UpDownCounter`            `SumAggregation`
    `opensafely._vendor.opentelemetry.sdk.metrics.ObservableCounter`        `SumAggregation`
    `opensafely._vendor.opentelemetry.sdk.metrics.ObservableUpDownCounter`  `SumAggregation`
    `opensafely._vendor.opentelemetry.sdk.metrics.Histogram`                `ExplicitBucketHistogramAggregation`
    `opensafely._vendor.opentelemetry.sdk.metrics.ObservableGauge`          `LastValueAggregation`
    ==================================================== ====================================
    """
