...
from opensafely._vendor.opentelemetry.sdk.metrics._internal._view_instrument_match import (
...
from opensafely._vendor.opentelemetry.sdk.metrics._internal.export import AggregationTemporality
