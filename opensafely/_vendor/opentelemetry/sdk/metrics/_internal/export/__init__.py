...
from opensafely._vendor.opentelemetry.context import (
...
from opensafely._vendor.opentelemetry.sdk.metrics._internal.point import MetricsData
...
class MetricExporter(ABC):
    ...
    Args:
        preferred_temporality: Used by `opensafely._vendor.opentelemetry.sdk.metrics.export.PeriodicExportingMetricReader` to
            configure exporter level preferred temporality. See `opensafely._vendor.opentelemetry.sdk.metrics.export.MetricReader` for
            more details on what preferred temporality is.
        preferred_aggregation: Used by `opensafely._vendor.opentelemetry.sdk.metrics.export.PeriodicExportingMetricReader` to
            configure exporter level preferred aggregation. See `opensafely._vendor.opentelemetry.sdk.metrics.export.MetricReader` for
    ...
    def __init__(
        ...
        preferred_aggregation: dict[
            type, "opensafely._vendor.opentelemetry.sdk.metrics.view.Aggregation"
        ]
        | None = None,
    ) -> None:
    ...
    def export(
        ...
        **kwargs,
        ...
        Args:
            metrics: The list of `opensafely._vendor.opentelemetry.sdk.metrics.export.Metric` objects to be exported
...
class ConsoleMetricExporter(MetricExporter):
    ...
    def __init__(
        ...
        out: IO = stdout,
        formatter: Callable[
            ["opensafely._vendor.opentelemetry.sdk.metrics.export.MetricsData"], str
...
class MetricReader(ABC):
    ...
    def __init__(
        ...
        self._collect: Callable[
            ...
            Iterable["opensafely._vendor.opentelemetry.sdk.metrics.export.Metric"],
        ] = None
    ...
    def _receive_metrics(
        self,
        metrics_data: "opensafely._vendor.opentelemetry.sdk.metrics.export.MetricsData",
        timeout_millis: float = 10_000,
        **kwargs,
    ) -> None:
    ...
    def shutdown(self, timeout_millis: float = 30_000, **kwargs) -> None:
        ...
        :class:`~opensafely._vendor.opentelemetry.sdk.metrics.MeterProvider`,
        :meth:`~opensafely._vendor.opentelemetry.sdk.metrics.MeterProvider.shutdown` will invoke this
        automatically.
        """
...
class InMemoryMetricReader(MetricReader):
    ...
    def __init__(
        ...
        self._lock = RLock()
        self._metrics_data: "opensafely._vendor.opentelemetry.sdk.metrics.export.MetricsData" = (
            None
        )

    def get_metrics_data(
        self,
    ) -> Optional["opensafely._vendor.opentelemetry.sdk.metrics.export.MetricsData"]:
