...
.. code:: python
    ...
    from opensafely._vendor.opentelemetry.sdk.error_handler import ErrorHandler
...
.. code:: python
    ...
    from opensafely._vendor.opentelemetry.sdk.error_handler import GlobalErrorHandler
