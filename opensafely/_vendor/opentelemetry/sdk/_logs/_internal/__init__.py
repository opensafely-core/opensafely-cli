...
from opensafely._vendor.opentelemetry._logs import Logger as APILogger
from opensafely._vendor.opentelemetry._logs import LoggerProvider as APILoggerProvider
from opensafely._vendor.opentelemetry._logs import LogRecord as APILogRecord
from opensafely._vendor.opentelemetry._logs import (
    NoOpLogger,
    SeverityNumber,
    get_logger,
    get_logger_provider,
...
from opensafely._vendor.opentelemetry.sdk.util import ns_to_iso_str
from opensafely._vendor.opentelemetry.sdk.util.instrumentation import InstrumentationScope
from opensafely._vendor.opentelemetry.semconv.trace import SpanAttributes
from opensafely._vendor.opentelemetry.trace import (
    format_span_id,
    format_trace_id,
    get_current_span,
)
from opensafely._vendor.opentelemetry.trace.span import TraceFlags
from opensafely._vendor.opentelemetry.util.types import AnyValue, Attributes
