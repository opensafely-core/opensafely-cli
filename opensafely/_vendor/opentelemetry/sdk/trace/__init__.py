...
from opensafely._vendor.opentelemetry import context as context_api
from opensafely._vendor.opentelemetry import trace as trace_api
from opensafely._vendor.opentelemetry.attributes import BoundedAttributes
from opensafely._vendor.opentelemetry.sdk import util
...
from opensafely._vendor.opentelemetry.sdk.trace import sampling
from opensafely._vendor.opentelemetry.sdk.trace.id_generator import IdGenerator, RandomIdGenerator
from opensafely._vendor.opentelemetry.sdk.util import BoundedList
from opensafely._vendor.opentelemetry.sdk.util.instrumentation import (
    InstrumentationInfo,
    InstrumentationScope,
)
from opensafely._vendor.opentelemetry.semconv.attributes.exception_attributes import (
    EXCEPTION_ESCAPED,
    EXCEPTION_MESSAGE,
    EXCEPTION_STACKTRACE,
    EXCEPTION_TYPE,
)
from opensafely._vendor.opentelemetry.trace import NoOpTracer, SpanContext
from opensafely._vendor.opentelemetry.trace.status import Status, StatusCode
from opensafely._vendor.opentelemetry.util import types
from opensafely._vendor.opentelemetry.util._decorator import _agnosticcontextmanager
