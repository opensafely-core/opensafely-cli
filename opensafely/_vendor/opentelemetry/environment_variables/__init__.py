...
.. note::
    ...
    either a `opensafely._vendor.opentelemetry.sdk.metrics.export.MetricExporter` (push exporter) or
    `opensafely._vendor.opentelemetry.sdk.metrics.export.MetricReader` (pull exporter) subclass; it must be
