...
from opensafely._vendor.opentelemetry.baggage import _is_valid_pair, get_all, set_baggage
...
from opensafely._vendor.opentelemetry.propagators import textmap
from opensafely._vendor.opentelemetry.util.re import _DELIMITER_PATTERN
