...
from opensafely._vendor.opentelemetry.proto.collector.metrics.v1.metrics_service_pb2 import (
    ExportMetricsServiceRequest,
)
from opensafely._vendor.opentelemetry.proto.metrics.v1 import metrics_pb2 as pb2
...
from opensafely._vendor.opentelemetry.sdk.metrics import (
    Counter,
    Exemplar,
    Histogram,
    ObservableCounter,
...
from opensafely._vendor.opentelemetry.sdk.metrics.view import (
    Aggregation,
