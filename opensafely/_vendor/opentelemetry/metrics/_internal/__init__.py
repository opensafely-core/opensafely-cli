...
The following code shows how to obtain a meter using the global :class:`.MeterProvider`::
    ...
    from opensafely._vendor.opentelemetry.metrics import get_meter
...
from opensafely._vendor.opentelemetry.environment_variables import OTEL_PYTHON_METER_PROVIDER
from opensafely._vendor.opentelemetry.metrics._internal.instrument import (
    CallbackT,
    Counter,
    Histogram,
    NoOpCounter,
