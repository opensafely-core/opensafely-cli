...
Example::
    ...
    from opensafely._vendor.opentelemetry import propagate
...
from opensafely._vendor.opentelemetry.environment_variables import OTEL_PROPAGATORS
from opensafely._vendor.opentelemetry.propagators import composite, textmap
...
def _load_propagators() -> textmap.TextMapPropagator:
    ...
    if not configured:
        ...
        from opensafely._vendor.opentelemetry.baggage.propagation import (  # noqa: PLC0415
            W3CBaggagePropagator,
        )

        # pylint: disable=import-outside-toplevel,no-name-in-module
        from opensafely._vendor.opentelemetry.trace.propagation.tracecontext import (  # noqa: PLC0415
    ...
    # pylint: disable=import-outside-toplevel,no-name-in-module
    from opensafely._vendor.opentelemetry.util._importlib_metadata import (  # noqa: PLC0415
        entry_points,
    )
