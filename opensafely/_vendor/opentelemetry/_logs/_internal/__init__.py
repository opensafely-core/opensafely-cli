...
The following code shows how to obtain a logger using the global :class:`.LoggerProvider`::
    ...
    from opensafely._vendor.opentelemetry._logs import get_logger
...
from opensafely._vendor.opentelemetry.context import get_current
from opensafely._vendor.opentelemetry.context.context import Context
from opensafely._vendor.opentelemetry.environment_variables import _OTEL_PYTHON_LOGGER_PROVIDER
from opensafely._vendor.opentelemetry.trace import get_current_span
...
from opensafely._vendor.opentelemetry.util.types import AnyValue, _ExtendedAttributes
