...
from opensafely._vendor.opentelemetry.context import create_key, get_value, set_value
from opensafely._vendor.opentelemetry.context.context import Context
from opensafely._vendor.opentelemetry.trace.span import INVALID_SPAN, Span
