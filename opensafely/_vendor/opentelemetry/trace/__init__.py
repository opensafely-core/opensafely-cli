...
change, and the caller is responsible for managing the span's lifetime::
    ...
    from opensafely._vendor.opentelemetry.trace import set_span_in_context
...
from opensafely._vendor.opentelemetry.attributes import BoundedAttributes  # type: ignore
from opensafely._vendor.opentelemetry.context.context import Context
from opensafely._vendor.opentelemetry.environment_variables import OTEL_PYTHON_TRACER_PROVIDER
from opensafely._vendor.opentelemetry.trace.propagation import (
    _SPAN_KEY,
    get_current_span,
    set_span_in_context,
)
from opensafely._vendor.opentelemetry.trace.span import (
