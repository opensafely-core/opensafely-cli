...
from opensafely._vendor import wrapt

try:
    # If the C extension for wrapt was compiled and opensafely._vendor.wrapt._wrappers.pyd exists, then the
    ...
    import opensafely._vendor.wrapt._wrappers
...
class ClassicAdapter(wrapt.AdapterFactory):
    ...
    .. code-block:: python
       ...
       from opensafely._vendor.deprecated.classic import ClassicAdapter
       from opensafely._vendor.deprecated.classic import deprecated
