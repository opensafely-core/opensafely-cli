...
"""
from opensafely._vendor.charset_normalizer.api import from_fp, from_path, from_bytes, normalize
from opensafely._vendor.charset_normalizer.legacy import detect
from opensafely._vendor.charset_normalizer.version import __version__, VERSION
from opensafely._vendor.charset_normalizer.models import CharsetMatch, CharsetMatches

# Backward-compatible v1 imports
from opensafely._vendor.charset_normalizer.models import CharsetNormalizerMatch
