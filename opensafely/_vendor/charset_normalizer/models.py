...
from opensafely._vendor.charset_normalizer.constant import TOO_BIG_SEQUENCE
from opensafely._vendor.charset_normalizer.md import mess_ratio
from opensafely._vendor.charset_normalizer.utils import iana_name, is_multi_byte_encoding, unicode_range
...
class CharsetMatch:
    ...
    def language(self) -> str:
        ...
        if not self._languages:
            ...
            from opensafely._vendor.charset_normalizer.cd import mb_encoding_languages, encoding_languages
