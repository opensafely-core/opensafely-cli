...
from opensafely._vendor.charset_normalizer.constant import TOO_SMALL_SEQUENCE, TOO_BIG_SEQUENCE, IANA_SUPPORTED
from opensafely._vendor.charset_normalizer.md import mess_ratio
from opensafely._vendor.charset_normalizer.models import CharsetMatches, CharsetMatch
from warnings import warn
import logging

from opensafely._vendor.charset_normalizer.utils import any_specified_encoding, is_multi_byte_encoding, identify_sig_or_bom, \
    should_strip_sig_or_bom, is_cp_similar, iana_name
from opensafely._vendor.charset_normalizer.cd import coherence_ratio, encoding_languages, mb_encoding_languages, merge_coherence_ratios
