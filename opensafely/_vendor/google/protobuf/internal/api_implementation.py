...
try:
  ...
  from opensafely._vendor.google.protobuf.internal import _api_implementation
...
if _implementation_type == 'cpp':
  try:
    # pylint: disable=g-import-not-at-top
    from opensafely._vendor.google.protobuf.pyext import _message
...
if _implementation_type == 'upb':
  try:
    # pylint: disable=g-import-not-at-top
    from opensafely._vendor.google._upb import _message
    _c_module = _message
    del _message
  except ImportError:
...
try:
  ...
  from opensafely._vendor.google.protobuf import enable_deterministic_proto_serialization
