...
from opensafely._vendor.ruamel.yaml.representer import Representer, SafeRepresenter, BaseRepresenter
from opensafely._vendor.ruamel.yaml.resolver import Resolver, BaseResolver

if False:  # MYPY
    from typing import Any, Union, Optional  # NOQA
    from opensafely._vendor.ruamel.yaml.compat import StreamTextType, StreamType, VersionType  # NOQA
