...
from opensafely._vendor.ruamel.yaml.compat import MutableSliceableSequence, _F, nprintf  # NOQA
...
class CommentedBase:
    ...
    def yaml_set_comment_before_after_key(
        ...
        """
        from opensafely._vendor.ruamel.yaml.error import CommentMark
        from opensafely._vendor.ruamel.yaml.tokens import CommentToken
