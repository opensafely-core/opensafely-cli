...
from opensafely._vendor.ruamel.yaml.compat import text_type, binary_type, to_unicode, PY2, PY3
from opensafely._vendor.ruamel.yaml.compat import ordereddict  # type: ignore
from opensafely._vendor.ruamel.yaml.compat import nprint, nprintf  # NOQA
...
from opensafely._vendor.ruamel.yaml.comments import (
    CommentedMap,
    CommentedOrderedMap,
    CommentedSeq,
    CommentedKeySeq,
