...
from opensafely._vendor.ruamel.yaml.compat import (utf8, builtins_module, to_str, PY2, PY3,  # NOQA
                                text_type, nprint, nprintf, version_tnf)
from opensafely._vendor.ruamel.yaml.compat import ordereddict, Hashable, MutableSequence  # type: ignore
from opensafely._vendor.ruamel.yaml.compat import MutableMapping  # type: ignore
...
from opensafely._vendor.ruamel.yaml.scalarint import ScalarInt, BinaryInt, OctalInt, HexInt, HexCapsInt
from opensafely._vendor.ruamel.yaml.scalarfloat import ScalarFloat
from opensafely._vendor.ruamel.yaml.scalarbool import ScalarBoolean
from opensafely._vendor.ruamel.yaml.timestamp import TimeStamp
