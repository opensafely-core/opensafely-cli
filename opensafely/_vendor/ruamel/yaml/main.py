...
from opensafely._vendor.ruamel.yaml.compat import StringIO, BytesIO, with_metaclass, PY3, nprint
...
class YAML(object):
    ...
    def seq(self, *args):
        # type: (Any) -> Any
        if 'rt' in self.typ:
            from opensafely._vendor.ruamel.yaml.comments import CommentedSeq
