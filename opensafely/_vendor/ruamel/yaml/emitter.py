...
import sys
from opensafely._vendor.ruamel.yaml.error import YAMLError, YAMLStreamError
from opensafely._vendor.ruamel.yaml.events import *  # NOQA

# fmt: off
from opensafely._vendor.ruamel.yaml.compat import utf8, text_type, PY2, nprint, dbg, DBG_EVENT, \
    check_anchorname_char
# fmt: on

if False:  # MYPY
    from typing import Any, Dict, List, Union, Text, Tuple, Optional  # NOQA
    from opensafely._vendor.ruamel.yaml.compat import StreamType  # NOQA
