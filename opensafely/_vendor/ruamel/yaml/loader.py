...
from opensafely._vendor.ruamel.yaml.composer import Composer
...
from opensafely._vendor.ruamel.yaml.resolver import VersionedResolver

if False:  # MYPY
    from typing import Any, Dict, List, Union, Optional  # NOQA
    from opensafely._vendor.ruamel.yaml.compat import StreamTextType, VersionType  # NOQA
